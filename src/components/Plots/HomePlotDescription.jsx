    ...
    <div className="max-w-7xl mx-auto px-4 py-8 mt-20">
      ...
      <div className="mb-12 text-center relative">
        ...
        <h1 className="text-lg sm:text-2xl md:text-3xl font-['Playfair_Display'] text-center font-semibold mb-4 sm:mb-6 leading-relaxed px-4">
          <TypeWriter
            text="Every great story begins with a single plot—make yours a masterpiece."
            speed={50}
          />
        </h1>
      ...
      <div className="flex items-center gap-2 text-sm text-gray-600 mb-6">
        ...
        <Link to="/rent" className="hover:text-red-500">Plots for Sale in Mumbai</Link> /
        <Link to="/rent" className="hover:text-red-500">Plots for Sale in Katrap</Link> /
        <span className="text-gray-900">1 bhk Flat for Sale in Katrap</span>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h1 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2">
                  "Residential Plot for Sale in City Pride, Badlapur East – Prime Location!"
                </h1>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
                ...
                <div className="text-sm font-medium group-hover:text-red-500 transition-all duration-300">Residential</div>
                <div className="text-xs text-gray-500 group-hover:text-red-400 transition-all duration-300">Plot Type</div>
              </div>
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
                <BiArea className="text-gray-400 mb-1 transition-all duration-300 group-hover:text-red-500 group-hover:rotate-12" size={20} />
                <div className="text-sm font-medium group-hover:text-red-500 transition-all duration-300">1500 Sq.Ft</div>
                <div className="text-xs text-gray-500 group-hover:text-red-400 transition-all duration-300">Plot Area</div>
              </div>
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
                ...
                <div className="text-sm font-medium group-hover:text-red-500 transition-all duration-300">₹2,500/Sq.Ft</div>
                <div className="text-xs text-gray-500 group-hover:text-red-400 transition-all duration-300">Price per Sq.Ft</div>
              </div>
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
              ...
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
                ...
                <div className="text-sm font-medium group-hover:text-red-500 transition-all duration-300">20 Feet</div>
                <div className="text-xs text-gray-500 group-hover:text-red-400 transition-all duration-300">Road Access</div>
              </div>
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
                <FaCompass className="text-gray-400 mb-1 transition-all duration-300 group-hover:text-red-500 group-hover:rotate-12" size={20} />
                <div className="text-sm font-medium group-hover:text-red-500 transition-all duration-300">East</div>
                <div className="text-xs text-gray-500 group-hover:text-red-400 transition-all duration-300">Facing Direction</div>
              </div>
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
                ...
                <div className="text-xs text-gray-500 group-hover:text-red-400 transition-all duration-300">Water Connection</div>
              </div>
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
                <FaBolt className="text-gray-400 mb-1 transition-all duration-300 group-hover:text-red-500 group-hover:rotate-12" size={20} />
                <div className="text-sm font-medium group-hover:text-red-500 transition-all duration-300">Available</div>
                <div className="text-xs text-gray-500 group-hover:text-red-400 transition-all duration-300">Electricity</div>
              </div>
              <div className="flex flex-col items-center p-2 bg-gray-50 rounded-lg transition-all duration-300 group hover:bg-red-50 hover:shadow-md hover:-translate-y-1 hover:scale-105">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6 transition-all duration-300 hover:shadow-lg">
            ...
            <div className="space-y-4 transition-all duration-300 hover:bg-gray-50/50 p-4 rounded-lg">
              <ul className="space-y-3">
                <li className="flex items-center justify-between py-2 border-b transition-all duration-300 hover:bg-red-50 hover:px-4 rounded-lg group hover:shadow-sm hover:-translate-x-1">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-red-500 transition-all duration-300">Residential</span>
                </li>
                <li className="flex items-center justify-between py-2 border-b transition-all duration-300 hover:bg-red-50 hover:px-4 rounded-lg group hover:shadow-sm hover:-translate-x-1">
                  <span className="text-gray-600 flex items-center gap-2 group-hover:text-red-500 transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-red-500 transition-all duration-300">1200 Sq.Ft</span>
                </li>
                <li className="flex items-center justify-between py-2 border-b transition-all duration-300 hover:bg-red-50 hover:px-4 rounded-lg group hover:shadow-sm hover:-translate-x-1">
                  <span className="text-gray-600 flex items-center gap-2 group-hover:text-red-500 transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-red-500 transition-all duration-300">30 feet</span>
                </li>
                <li className="flex items-center justify-between py-2 border-b transition-all duration-300 hover:bg-red-50 hover:px-4 rounded-lg group hover:shadow-sm hover:-translate-x-1">
                  <span className="text-gray-600 flex items-center gap-2 group-hover:text-red-500 transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-red-500 transition-all duration-300">North-East</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="space-y-4 transition-all duration-300 hover:bg-gray-50/50 p-4 rounded-lg">
              <ul className="space-y-3">
                <li className="flex items-center justify-between py-2 border-b transition-all duration-300 hover:bg-red-50 hover:px-4 rounded-lg group hover:shadow-sm hover:-translate-x-1">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-red-500 transition-all duration-300">₹25,00,000</span>
                </li>
                <li className="flex items-center justify-between py-2 border-b transition-all duration-300 hover:bg-red-50 hover:px-4 rounded-lg group hover:shadow-sm hover:-translate-x-1">
                  <span className="text-gray-600 flex items-center gap-2 group-hover:text-red-500 transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-red-500 transition-all duration-300">₹2,500</span>
                </li>
                <li className="flex items-center justify-between py-2 border-b transition-all duration-300 hover:bg-red-50 hover:px-4 rounded-lg group hover:shadow-sm hover:-translate-x-1">
                  <span className="text-gray-600 flex items-center gap-2 group-hover:text-red-500 transition-all duration-300">
                  ...
                  <span className="font-medium text-gray-900 group-hover:text-red-500 transition-all duration-300">Extra</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              { icon: FaFileAlt, name: 'RERA Approved' },
              { icon: FaRoad, name: 'Corner Plot' },
              { icon: FaShieldAlt, name: 'Gated Community' },
              { icon: FaTree, name: 'Garden Area' },
              { icon: FaWater, name: 'Water Connection' },
              ...
              >
                <feature.icon
                  ...
                  size={28}
                />
                <span className="text-gray-700 group-hover:text-red-500">{feature.name}</span>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="flex items-center mb-4">
            <div className="relative flex items-center group">
              ...
              <div className="relative bg-red-500 text-white px-8 py-4 rounded-full flex items-center gap-3 transform transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <span className="text-2xl font-semibold">About Plot</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg transition-all duration-300 hover:bg-red-50 group">
              <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-all duration-300">
                This premium residential plot is located in the heart of Badlapur East, offering a perfect opportunity to build your dream home. Spanning across 2000 Sq.Ft, the plot is well-connected to key locations and comes with essential amenities.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg transition-all duration-300 hover:bg-red-50 group">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 group-hover:text-gray-700">
                <li className="transition-all duration-300 hover:translate-x-1">
                  Clear land title with legal approvals
                </li>
                <li className="transition-all duration-300 hover:translate-x-1">
                  Well-developed road access to the plot
                </li>
                <li className="transition-all duration-300 hover:translate-x-1">
            ...
            <div className="p-4 rounded-lg transition-all duration-300 hover:bg-red-50 group">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 group-hover:text-gray-700">
                <li className="transition-all duration-300 hover:translate-x-1">
                  1 km from Badlapur Railway Station
                </li>
                <li className="transition-all duration-300 hover:translate-x-1">
            ...
            <div className="p-4 rounded-lg transition-all duration-300 hover:bg-red-50 group">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 group-hover:text-gray-700">
                ...
                <li className="transition-all duration-300 hover:translate-x-1">
                  Gated community with security provisions
                </li>
                <li className="transition-all duration-300 hover:translate-x-1">
                  Surrounded by upcoming real estate developments
                </li>
              </ul>
            </div>
          </div>
...
export default HomePlotDescription;
